      ...
      <?php foreach ($pagination['paginator'] as $data) : ?>
        ...
        <tr>
          ...
          <td align="center" width="1%">
            <button type="button" class="btn btn-sm <?= ($data['Text19'] == 1) ? 'btn-success-light' : 'btn-secondary' ?> py-0">DS</button>
            <button type="button" class="btn btn-sm <?= ($data['Text20'] == 1) ? 'btn-success-light' : 'btn-secondary' ?> py-0">AX</button>
          </td>
          <td align="center" width="1%">
