            ...
            <?php foreach ($pagination['paginator'] as $data) : ?>
                ...
                <tr>
                    ...
                    <td align="center" width="1%">
                        <!-- <button type="button" class="btn btn-sm btn-warning py-0" onClick="endPlan('<?= $data['Dyelot'] ?>', '<?= $data['Text11'] ?>')">FIX</button> -->
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
    ...
    <div class="d-flex justify-content-between">
        ...
        <nav>
            <ul class="pagination">
                ...
                <li class="page-item m-0  <?= $pagination['now'] == $pagination['lastPage'] ? 'disabled' : ''; ?>"><BUTTON class="page-link paginator" data-page="<?= ($pagination['now'] + 1) ?>">Next</BUTTON></li>
            </ul>
        </nav>
    </div>
</div>